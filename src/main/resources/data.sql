...
CREATE TABLE IF NOT EXISTS country_image (
    country_image_id BIGINT PRIMARY KEY,
...
-- 테이블이 존재하지 않는 경우에만 생성
CREATE TABLE IF NOT EXISTS teenieping_image (
    teenieping_image_id BIGINT PRIMARY KEY,
    teenieping_name VARCHAR(255),
    teenieping_image_link VARCHAR(255)
);

--Teenieping Image 데이터 삽입
INSERT IGNORE INTO teenieping_image (teenieping_image_id, teenieping_name, teenieping_image_link) VALUES
(1, '고쳐핑', ''),
(2, '공쥬핑', ''),
(3, '그림핑', ''),
(4, '까르핑', ''),
...
CREATE TABLE IF NOT EXISTS people_image (
    people_image_id BIGINT PRIMARY KEY,
    people_name VARCHAR(255),
    people_image_link VARCHAR(255)
);

--People Image 데이터 삽입
INSERT IGNORE INTO people_image (people_image_id, people_name, people_image_link) VALUES
(1, '가인', ''),
(2, '강동원', ''),
(3, '공효진', ''),
(4, '권상우', ''),
...
-- 테이블이 존재하지 않는 경우에만 생성
CREATE TABLE IF NOT EXISTS catchmind (
    catchmind_id BIGINT PRIMARY KEY,
    word VARCHAR(255)
);

--Catchmind Image 데이터 삽입
INSERT IGNORE INTO catchmind (catchmind_id, word) VALUES
(1, '강아지'),
(2, '바다'),
(3, '초콜릿'),
(4, '사과나무'),
